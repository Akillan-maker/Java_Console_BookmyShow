...
public class Show {
    private LocalTime starttime;    // To store start time of show
    private LocalTime endtime;    // To store end time of show
    private LocalDate dateofshow;      // To store show date
    private HashMap<Character, ArrayList<String>> seatsofshow=new HashMap<>();   // To store seats and grids od show
